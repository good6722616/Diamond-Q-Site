...
export default function CatalogueSection() {
  ...
  return (
    <div className="containter py-8">
      <div className="flex items-center justify-center md:justify-around">
        <h1 className="py-4 md:mx-8 text-3xl font-bold lg:text-5xl lg:py-0">
          Our Services
        </h1>
      </div>
      ...
      <div className="grid gap-8 divide-gray-300 lg:divide-x lg:gap-0 lg:grid-cols-4 md:grid-cols-2">
        {items.map((item) => (
          <div key={item.id} className="overflow-hidden group">
            ...
            {/* <div className="p-8 m-12 bg-white bg-opacity-60 backdrop-sepia-0 ">
              <div className="flex justify-between pb-4 ">
                <p className="text-sm">{item.catagory}</p>
                <span className="text-sm ">{item.id}</span>
              </div>
